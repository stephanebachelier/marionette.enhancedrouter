(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Backbone.LazyRouter = factory(root.Backbone, root._);
  }
  ...
  var LazyRouter = Backbone.Router.extend({
    ...
    _addAppRoute: function (route, methodName) {
      var method = function () {
        console.log('trigger route #', methodName, 'with args', arguments);
    ...
    onBeforeRoute: function (routeName) {
      console.log('onBeforeRoute', routeName);
      if (!this.isStarted) {
        this.isStarted = true;
        this.lazyStartup();
      }
    ...
    onAfterRoute: function (routeName, routePath, routeArgs) {
      console.log('onAfterRoute', routeName, routePath, routeArgs);
